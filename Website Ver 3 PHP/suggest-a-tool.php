                    ...
                    <div class="nav-bar">
                        ...
                        <div class="symptoms-dropdown">
                            ...
                            <div class="symptoms-dropdown-content">
                                <ul>
                                    <li><a href="symptoms/anxiety-depression.php">Anxiety & Depression</a></li>
                                    <li><a href="symptoms/back-spine.php">Back/Spine</a></li>
                                    <li><a href="symptoms/balance-coordination.php">Balance & Co-ordination</a></li>                                    
                                    <li><a href="symptoms/bladder-bowels.php">Bladder & Bowels</a></li>
                                    <li><a href="symptoms/cognition.php">Cognition</a></li>
                                    <li><a href="symptoms/fatigue.php">Fatigue</a></li>
                                    <li><a href="symptoms/light-sensitivity.php">Light Sensitivity</a></li>
                                    <li><a href="symptoms/numbness-tingling.php">Numbness & Tingling</a></li>
                                    <li><a href="symptoms/optic-neuritis.php">Optic Neuritis</a></li>
                                    <li><a href="symptoms/pain.php">Pain</a></li>
                                    <li><a href="symptoms/sexual-issues.php">Sexual Issues</a></li>
                                    <li><a href="symptoms/sleep-issues.php">Sleep Issues</a></li>
                                    <li><a href="symptoms/spasms.php">Spasms</a></li>
                                    <li><a href="symptoms/speech.php">Speech</a></li>
                                    <li><a href="symptoms/stiffness.php">Stiffness</a></li>
                                    <li><a href="symptoms/swallowing.php">Swallowing</a></li>
                                    <li><a href="symptoms/temperature-sensitivity.php">Temperature Sensitivity</a></li>
                                    <li><a href="symptoms/vertigo.php">Vertigo</a></li>
                                    <li><a href="symptoms/walking.php">Walking</a></li>
                                    <li><a href="symptoms/weakness.php">Weakness</a></li>
                                </ul>
                            </div>
                        </div>
